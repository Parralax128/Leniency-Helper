...
public class TweakSetting<T> : TextMenu.Option<T>
{
    ...
    public TweakSetting(string tweak, string settingName, bool dontSetValue = false, bool isTweakSlider = false)
    ...
    private static string TweakFromDialog(string str)
    {
        return Dialog.Clean("LENIENCYTWEAKS_" + str.ToUpper());
    }
